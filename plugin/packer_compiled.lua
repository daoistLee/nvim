...
_G.packer_plugins = {
  LuaSnip = {
    loaded = true,
    path = "/home/daoist/.local/share/nvim/site/pack/packer/start/LuaSnip",
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-look", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-path", "cmp-spell" },
