...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-spell", "LuaSnip", "cmp-buffer", "cmp-look", "cmp_luasnip", "cmp-nvim-lsp", "cmp-cmdline", "cmp-nvim-lsp-document-symbol", "cmp-nvim-lua" },
