...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-look", "cmp-nvim-lsp-document-symbol", "cmp-nvim-lua", "cmp-spell", "cmp_luasnip", "LuaSnip", "cmp-path", "cmp-nvim-lsp" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-textobjects", "completion-treesitter", "nvim-treesitter-refactor" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'surround.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-cursorline', 'nvim-lspconfig'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'which-key.nvim', 'packer.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-cursorline', 'nvim-lspconfig'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
