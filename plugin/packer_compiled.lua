...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-look", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-spell", "cmp-path", "cmp_luasnip", "cmp-nvim-lsp-document-symbol", "LuaSnip" },
