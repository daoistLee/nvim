...
_G.packer_plugins = {
  ...
  ["dashboard-nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/daoist/.local/share/nvim/site/pack/packer/opt/dashboard-nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-path", "cmp-spell", "LuaSnip", "cmp-buffer", "cmp-cmdline", "cmp_luasnip", "cmp-look", "cmp-nvim-lsp", "cmp-nvim-lsp-document-symbol" },
