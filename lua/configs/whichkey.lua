return function()
    ...
    whick_key.register({
       ...
       ["<leader>wc"] = { "<Cmd>quit!<CR>", "window conceal" },
        ...
        ["<leader>ld"] = { "<cmd>Lspsaga peek_definition<CR>", "preview definition" },
        ["<leader>lw"] = { "<cmd>Lspsaga show_workspace_diagnostics ++normal<CR>", "show workspace diagnostics" },
        ["<leader>lc"] = { name = "lsp callhierarchy" },
        ["<leader>lco"] = { "<cmd>Lspsaga outgoing_calls ++float<CR>", "outgoing_calls" },
        ["<leader>lci"] = { "<cmd>Lspsaga incoming_calls ++float<CR>", "incoming_calls" },
        ...
        ["<leader>ls"] = { "<cmd>Lspsaga outline<CR>", "symboloutline" },
